...
# nicht nach.
#
# Aufgerufen wird dieses Skript bei JEDER Entfernungsart: bei der endgueltigen
# Entfernung mit $1 = 0, beim Upgrade mit der Zahl der verbleibenden
# Installationen. Das ist hier richtig und ausdruecklich gewollt: gerade beim
# Upgrade darf keine laufende Datei ersetzt werden. Es wird daher NICHT nach
# dem ersten Argument unterschieden -- anders als im postrm, wo genau diese
# Unterscheidung den Ausschlag gibt.
#
