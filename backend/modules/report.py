...
def generate_report(
    ...
    col_w = [28*mm, 35*mm, 38*mm, 35*mm, W - 136*mm]
    ...
    story.append(Paragraph(
        f"Generated by CERNIS PRO v1.0b  ·  {now}  ·  Scan ID: {scan.get('id', '—')}",
        S("F", fontName="Helvetica", fontSize=7, textColor=C_MUTED,
