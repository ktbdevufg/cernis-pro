...
sondern spaeter im Composition Root (Regel 5). Auch die Herkunft der erwarteten Menge
(die als vertraut kuratierten Server, ``application.dns_trust.TrustedDnsServerIps``)
faellt dort -- der ``ExpectedServersProvider`` bekommt die fertige Menge hier bereits
herein.
"""
...
# Liefert die erwartete-Resolver-Menge (roh). Ihre Herkunft (die als vertraut kuratierten
