...
# ============================================================
#  CERNIS PRO – Windows x64 PyInstaller Spec
#  Build:  pyinstaller cernis_windows.spec
# ============================================================
import os
import sys
...
# ── Windows: include frontend-dist INSIDE the bundle (_MEIPASS)
...
if not os.path.exists(frontend_dist):
    raise SystemExit(
        ...
        "  erzeugt wird dieses Verzeichnis von Schritt [2/6] 'Frontend bauen'\n"
        "  in build.ps1 (npm run build im Verzeichnis frontend/).\n"
